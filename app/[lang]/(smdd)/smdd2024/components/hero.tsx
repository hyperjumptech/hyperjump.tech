...
export default function SmddHero({ lang }: { lang: SupportedLanguage }) {
  return (
    <div className="relative h-full w-full bg-[url('/images/smdd/bg.jpg')] bg-cover bg-center px-4 pt-16 md:pb-5">
      <div className="absolute inset-0 z-10 bg-black opacity-40"></div>
      <div className="relative z-40 container mx-auto my-8 w-full text-white">
        <h1 className="mt-0 mb-8 text-2xl leading-tight font-bold xl:my-4 xl:text-5xl">
