...
export function LanguagePicker({ lang }: LanguagePickerProps) {
  ...
  return (
    <select
      ...
      className="cursor-pointer appearance-none rounded-full border border-[#2D364A] bg-transparent px-3 py-2 text-sm font-medium text-white focus:ring-1 focus:ring-white/30 focus:outline-none">
