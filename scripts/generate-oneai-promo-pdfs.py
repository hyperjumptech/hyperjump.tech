...
EN = {
    ...
    "p2_eyebrow": "WHY CREDITS OR STIPENDS AREN'T ENOUGH",
    "p2_heading": "ChatGPT seats cost less for small teams. OneAI saves money once you need control, multiple models, one budget — and data that stays with you.",
    ...
    "fit_text": "Rp12,400,000 for up to 40 users, including USD 300 credit — with on-prem or isolated hosting, ZDR, RAG, and model control.",
    "table_label": "COST AND CAPABILITY COMPARISON · PER MONTH",
    "cols": ["", "Individual stipends", "ChatGPT Business", "OneAI"],
    "rows": [
        ["20 users", "Rp10,000,000", "Rp8,000,000", "Rp12,400,000"],
        ["40 users", "Rp20,000,000", "Rp16,000,000", "Rp12,400,000 · fixed"],
        ["AI credit included", "No", "Bought separately", "USD 300/month"],
        ["Single invoice & reports", "No", "ChatGPT only", "Yes · all models"],
        ["Admin chooses models", "No", "Limited", "Yes"],
        ["Multi-model", "Depends", "OpenAI only", "Yes"],
        ["Zero Data Retention", "No", "Not ZDR", "Yes"],
        ["On-prem or isolated host", "No", "Vendor cloud", "Yes"],
        ["Knowledge, files, code", "No", "Limited", "Yes"],
    ],
    "assumptions": "Assumptions: Rp16,000/USD. Stipend example Rp500,000/person. ChatGPT Business $25/user/month. USD 300 ≈ Rp4,800,000. Competitor prices may change; not their quotes.",
    "whys": [
        (
        ...
        (
            "Per-seat costs scale linearly",
            "ChatGPT Business for 40 people ≈ Rp16 million before extra credits. OneAI stays at Rp12.4 million.",
        ),
        (
            "Data and extras cost more elsewhere",
            "On-prem, ZDR, RAG, files, and model control are usually separate projects. On OneAI they are one platform.",
        ),
    ],
...
ID = {
    ...
    "p2_eyebrow": "KENAPA TIDAK CUKUP BELI KREDIT ATAU KASIH TUNJANGAN?",
    "p2_heading": "Kursi ChatGPT lebih murah untuk tim kecil. OneAI lebih hemat begitu Anda butuh kontrol, banyak model, satu anggaran — dan data yang tetap di sisi Anda.",
    ...
    "fit_text": "Rp12.400.000 sampai 40 pengguna, termasuk kredit USD 300 — dengan on-premise atau hosting terisolasi, ZDR, RAG, dan kontrol model.",
    "table_label": "PERBANDINGAN BIAYA DAN KEMAMPUAN · PER BULAN",
    "cols": ["", "Tunjangan individu", "ChatGPT Business", "OneAI"],
    "rows": [
        ["20 pengguna", "Rp10.000.000", "Rp8.000.000", "Rp12.400.000"],
        ["40 pengguna", "Rp20.000.000", "Rp16.000.000", "Rp12.400.000 · tetap"],
        ["Kredit AI termasuk", "Tidak", "Dibeli terpisah", "USD 300/bulan"],
        ["Satu tagihan & laporan", "Tidak", "Hanya ChatGPT", "Ya · semua model"],
        ["Admin pilih model", "Tidak", "Terbatas", "Ya"],
        ["Multi-model", "Tergantung", "OpenAI saja", "Ya"],
        ["Zero Data Retention", "Tidak", "Bukan ZDR", "Ya"],
        ["On-premise / terisolasi", "Tidak", "Cloud vendor", "Ya"],
        ["Pengetahuan, file, kode", "Tidak", "Terbatas", "Ya"],
    ],
    "assumptions": "Asumsi: kurs Rp16.000/USD. Tunjangan contoh Rp500.000/orang. ChatGPT Business $25/orang/bulan. USD 300 ≈ Rp4.800.000. Harga kompetitor bisa berubah; bukan kuotasi mereka.",
    "whys": [
        (
        ...
        (
            "Kursi per orang naik linear",
            "ChatGPT Business di 40 orang ≈ Rp16 juta sebelum kredit extra. OneAI tetap Rp12,4 juta.",
        ),
        (
            "Data dan fitur extra lebih mahal di tempat lain",
            "On-premise, ZDR, RAG, file, dan kontrol model biasanya proyek terpisah. Di OneAI itu satu platform.",
        ),
    ],
